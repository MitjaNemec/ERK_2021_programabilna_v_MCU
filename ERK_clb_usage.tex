...
Inkrementalni dajalnik je senzor kota gredi, ki generira dva digitalna signale
A, B.  Signala sta pravokotne oblike z vklopnim razmerjem 50\% in sta med seboj
zamaknjena za 90°. Tako preko faznega premika med njima sklepamo o hitrosti
vrtenja, frekvenca signalov pa nosi informacijo o hitrosti vrtenja.

Za simulacijo inkrementalnega dajalnika bomo za podatek o hitrosti vrtenja
...
posvečal takšnim vezjim. Predvsem pa povezave CLB-ja z ostalimi perifernimi
napravami \cite{fpga-to-clb} omogočajo, da se CLB uporabi tudi samo za
razširitev funkcionalnosti PWM naprave (e.g. SPI vodilu lahko dodamo
kompenzacijo zamika signalvo med prenosom, združujemo več PWM signalov za PWM
moduliran PWM signal, ...
