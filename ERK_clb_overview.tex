...
% če se slika zamenja, se tale odstavek spremeni. Jaz ne bi omenjila lokalnega, globalnega in sistemskega vodila
% ja na tem mestu že preveč specifično. Dovolj bo da se pove, da so vhodi v CLB lahko GPIO ali periferne naprave ali izhodi drugih delov(tile) CLB-ja. Prav tako izhodi.
...
% ta slika ima precej nepotrebnih informacij
% mogoče bi jo zamenjal z Figure 2-5 iz spraco2a
\begin{figure*}[t]
    \begin{center}
...
% tole bi tudi veljalo razmisliti, da se zamenja z Figure 2-11 iz spraco2a
